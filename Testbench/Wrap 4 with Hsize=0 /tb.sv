...
module ahb_top_tb;
    ...
    initial begin
        ...
        // ==========================================================
        // PART 1: WRAP4 BYTE BURST WRITE (4 Beats, Hsize = 3'b000)
        // Master automatically calculates wrapping addresses from Haddr_m
        // ==========================================================
        ...
        // ==========================================================
        // PART 2: WRAP4 BYTE BURST READ (4 Beats, Hsize = 3'b000)
        // ==========================================================
