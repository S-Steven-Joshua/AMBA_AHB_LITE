<img width="1571" height="811" alt="Image" src="https://github.com/user-attachments/assets/3d5f8a59-4354-47e3-8039-558e678eb093" />

## AHB WRAP4 Burst — 2-Byte Write and Read

The following simulation demonstrates an **AHB WRAP4 burst** for both **write and read operations** with `HSIZE = 1`.

The burst starts at address `0x0000_0012`. Since `HSIZE = 1`, each transfer is **2 bytes**. With `HBURST = WRAP4`, the burst consists of 4 beats and wraps around an 8-byte address boundary.
...
|-----------|------|---------------|---------|----------|----------|----------|---------|------------|
| Write | 1 | 45–55 ns | `0x0000_0012` | `NONSEQ` | `1` | `WRAP4` | `1` (2B) | 55–65 ns |
| Write | 2 | 55–65 ns | `0x0000_0014` | `SEQ` | `1` | `WRAP4` | `1` (2B) | 65–75 ns |
| Write | 3 | 65–75 ns | `0x0000_0016` | `SEQ` | `1` | `WRAP4` | `1` (2B) | 75–85 ns |
| Write | 4 | 75–85 ns | `0x0000_0010` | `SEQ` | `1` | `WRAP4` | `1` (2B) | 85–95 ns |
| Read | 1 | 125–135 ns | `0x0000_0012` | `NONSEQ` | `0` | `WRAP4` | `1` (2B) | 135–145 ns |
| Read | 2 | 135–145 ns | `0x0000_0014` | `SEQ` | `0` | `WRAP4` | `1` (2B) | 145–155 ns |
| Read | 3 | 145–155 ns | `0x0000_0016` | `SEQ` | `0` | `WRAP4` | `1` (2B) | 155–165 ns |
| Read | 4 | 155–165 ns | `0x0000_0010` | `SEQ` | `0` | `WRAP4` | `1` (2B) | 165–175 ns |
