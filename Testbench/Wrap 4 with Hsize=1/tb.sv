...
module ahb_top_tb;
    ...
    initial begin
        ...
        // ==========================================================
        // PART 1: WRAP4 HALFWORD BURST WRITE (4 Beats, Hsize = 3'b001)
        ...
        @(posedge Hclk);
        #1;
        Hwdata_m = 32'h0000_2222; // Data for beat 2
        Htrans_m = 2'b11;         // SEQ

        // Beat 3: Address Phase (SEQ) + Data Phase 2
        @(posedge Hclk);
        #1;
        Hwdata_m = 32'h0000_3333; // Data for beat 3
        Htrans_m = 2'b11;         // SEQ

        // Beat 4: Address Phase (SEQ) + Data Phase 3
        @(posedge Hclk);
        #1;
        Hwdata_m = 32'h0000_4444; // Data for beat 4
        Htrans_m = 2'b11;         // SEQ
        ...
        // ==========================================================
        // PART 2: WRAP4 HALFWORD BURST READ (4 Beats, Hsize = 3'b001)
        // ==========================================================
