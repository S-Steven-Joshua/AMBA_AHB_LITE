...
module ahb_top_tb;
    ...
    initial begin
        ...
        // ==========================================================
        // STEP 1: WRITE 5 BEATS (To populate RAM for reading)
        // ==========================================================
        @(posedge Hclk);
        #1;
        ...
        // ==========================================================
        // STEP 2: UNDEFINED INCR BURST READ (5 Beats, Hsize = 3'b010)
        // Master automatically calculates subsequent addresses from Haddr_m
        // ==========================================================

        // Beat 1: Address Phase (NONSEQ) - Initial read address
        @(posedge Hclk);
        #1;
        Haddr_m  = 32'h0000_0010;
